                ...
                c => new
                    {
                        ...
                        VendorSubscriptionId = c.String(),
                        EntitlementId = c.String(),
                        VendorOrderId = c.String(),
                        OriginalOrderItemId = c.Guid(nullable: false),
                        AzureTenantId = c.Guid(nullable: false),
                        OfferId = c.Guid(nullable: false),
                        Name = c.String(),
                        LastUsageMeteringDateUtc = c.DateTime(precision: 7, storeType: "datetime2"),
                        SubscriptionState = c.Int(nullable: false),
                        StartDateUtc = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        EndDateUtc = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        Quantity = c.Decimal(nullable: false, precision: 18, scale: 2),
                        InvoiceContractId = c.Guid(nullable: false),
                        VendorContractId = c.Guid(nullable: false),
                        AccountId = c.Guid(),
                        CustomerId = c.Guid(nullable: false),
                        BundleId = c.Guid(),
                        JsonData = c.String(),
                        MinimumCommitmentMonths = c.Byte(nullable: false),
                        InitialPurchaseValue = c.Decimal(precision: 18, scale: 2),
                ...
                c => new
                    {
                        ...
                        TimeOfWay1 = c.Double(nullable: false),
                        PropertiesChangesWay2 = c.String(),
                        TimeOfWay2 = c.Double(nullable: false),
                        TimeOfGetOldEntity = c.Double(nullable: false),
